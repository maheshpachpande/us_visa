...
from src.usVisaClassifier.utils import (save_object, 
    ...
    def initiate_data_transformation(self, ) -> DataTransformationArtifact:
        ...
        try:
            if self.data_validation_artifact.validation_status:
                ...
                input_feature_train_df = train_df.drop(columns=[self._cnf['target']['column']], axis=1)
                target_feature_train_df = train_df[self._cnf['target']['column']]

                logging.info("Got train features and test features of Training dataset")

                input_feature_train_df['company_age'] = 2025-input_feature_train_df['yr_of_estab']
                ...
                input_feature_test_df = test_df.drop(columns=[self._cnf['target']['column']], axis=1)

                target_feature_test_df = test_df[self._cnf['target']['column']]


                input_feature_test_df['company_age'] = 2025-input_feature_test_df['yr_of_estab']
